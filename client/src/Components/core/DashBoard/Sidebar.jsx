...
const Sidebar = ({ isSidebarOpen, setIsSidebarOpen }) => {
  ...
  return (
    <>
      ...
      <div
        className={`
          fixed z-50 top-0 left-0 h-full bg-richblack-800 text-richblack-100
          w-64 transform transition-transform duration-300 ease-in-out
          ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"}
          lg:translate-x-0 lg:relative lg:w-[15%] lg:py-10
        `}
      >
        <div className="flex flex-col gap-2 mt-16 lg:mt-0">
          ...
          <NavLink
            className={`text-sm flex gap-2 items-center px-10 py-2`}
            onClick={() =>
              setModalData({
                text1: "Are you sure?",
                text2: "You will be logged out of your account.",
          ...
          <NavLink className="text-sm flex gap-2 items-center px-10 py-2">
            <LuSettings />
            <span>Settings</span>
          </NavLink>
        </div>
